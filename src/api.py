...
class TempInput(BaseModel):
    Pclass: Annotated[
        Union[str, int], Field(..., description="Passenger class (1st, 2nd, or 3rd)")
    ]
    ...
    Siblings_Spouses_Aboard: Annotated[
        int, Field(..., description="Number of siblings or spouses aboard")
    ]
    Parents_Children_Aboard: Annotated[
        int, Field(..., description="Number of parents or children aboard")
    ]
